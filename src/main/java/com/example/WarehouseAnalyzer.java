...
class WarehouseAnalyzer {
    ...
    public List<Product> findProductsInPriceRange(BigDecimal minPrice, BigDecimal maxPrice) {
        ...
        for (Product p : warehouse.getWarehouseInventory()) {
    ...
    public Map<Category, BigDecimal> calculateWeightedAveragePriceByCategory() {
        Map<Category, List<Product>> byCat = warehouse.getWarehouseInventory().stream()
    ...
    public List<Product> findPriceOutliers(double standardDeviations) {
        List<Product> products = warehouse.getWarehouseInventory();
        int n = products.size();
    ...
    public InventoryValidation validateInventoryConstraints() {
        List<Product> items = warehouse.getWarehouseInventory();
